...
typedef __packed struct _SendData { 
	uint8_t start_flag; 
	float x;     // Yaw 
	float y;     // Pitch
    float z;     // state
...
typedef __packed struct _McuData {
    uint8_t start_flag;
    uint8_t type;
    uint32_t x;
    uint32_t y;
...
typedef __packed struct _PanData {
    uint8_t start_flag;
    uint8_t type;
    float yaw;
    float pitch;
...
typedef __packed struct _ConfigData {
    uint8_t start_flag;
    uint8_t type;
    uint8_t state;
    uint8_t anti_top;
...
typedef __packed struct _EnergyData {
    uint8_t start_flag;
    uint8_t type;
    int delta_x;
    int delta_y;
...
typedef __packed struct _SpeedData {
    uint8_t start_flag;
    uint8_t type;
    float speed;
    float empty_buff;
